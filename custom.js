$(document).ready(function() {
	...
	$('#help').click(function(e) {
		alert("This page is build by Mr,Sdp Ulak. With the help of Bootstrap 4. For the purpose of creating portfolio.None of the links are linked to other page but connected to the same page !!.");
		e.preventDefault();
	})
});